  ...
  const articles = [
    {
      ...
      description:
        "The exact strategies, tools, and mindset shifts that took our SaaS from idea to seven figures in 18 months.",
      image:
    ...
    },
    {
      ...
      description:
        "After pitching 47 investors, here's what actually matters in your deck and how to tell your story.",
      image:
        "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=400&h=300&fit=crop&crop=center",
      categoryColor: "text-green-400",
      link: "/first-round-funding",
    },
    {
      id: 3,
      category: "Founders",
      ...
      description:
        "Why most MVPs fail and the counterintuitive approach that actually validates your market.",
      image:
      ...
      <div className=" text-white overflow-hidden mt-12 py-4">
        ...
        <nav className="flex items-center justify-center pt-6 pb-4 px-4 sm:pt-8 sm:pb-6">
          <div className="flex items-center space-x-2 sm:space-x-4 text-gray-400 text-sm sm:text-base">
            ...
            <span className="text-gray-600">›</span>
            <span className="text-white">Foounders</span>
          </div>
        </nav>
